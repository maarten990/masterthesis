...
discourse. \Cref{fig:pdf_roi} shows the same page seen in
...
and size of the line. \Cref{fig:example} shows an example of a portion of
...
for by using stratified sampling. \Cref{fig:data_dist} shows the distribution of
