...
\todo[inline]{Rewrite this and add all the details about how the data is used
  (sliding window, etc)}
...
\todo[inline]{Either expand this section or just integrate it with the previous subsection.}
